                                        ...
                                        <div className="lg:flex mb-4 lg:mb-0">
                                            <div className='flex justify-center my-2 lg:my-0'>
                                                <div className="flex items-center justify-center bg-lime-600 mr-5 h-[106px] w-[106px] p-10">
                                                    ...
                                                    {d.tag === 'cp' && <FaMoneyCheckAlt className='text-white text-4xl' />}
                                                    {d.tag === 'bs' && <FaAward className='text-white text-4xl' />}
                                                    {d.tag === 'wc' && <AiOutlineGlobal className='text-white text-4xl' />}

                                                </div>
                                            </div>
                                            <div className="flex flex-col">
                                                <h5 className="text-xl font-semibold text-center lg:text-left">{d.title}</h5>
                                                <p className="m-0 text-sm text-center lg:text-justify">{d.desc}</p>
                                            </div>
                                        </div>
                                    </div>
                                </>
